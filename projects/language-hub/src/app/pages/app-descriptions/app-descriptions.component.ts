...
export class AppDescriptionsComponent implements OnInit {
  apps: App[] = [
    ...
    },
    {
      ...
      description:
        'This is a prototype for an interactive language learning game. We will eventually build a more comprehensive version of this game with newer technology. Currently available on Android 7.0 + only. We are changing the technology on this one to reach a broader audience. This game features ’respond-to-command’ as well as ’word-builder’ interactions. The ’word-builder’ approach encourages learners to focus separately on the stem or prefix as opposed to trying to digest long verbs whole. It was implemented by Aaron Plahn based on his experience with the language acquisition of children Briseis and Dakota, who have been learning from their grandparents Tina and Mary Setah. They mastered the meaning of verb stems quite early, and only began to make sense of the prefixes much later. Some of the things they say are quite comical!',
    },
  ];
